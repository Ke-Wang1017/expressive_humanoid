...
class StompyAMP(LeggedRobot):
    def __init__(self, cfg: LeggedRobotCfg, sim_params, physics_engine, sim_device, headless):
        ...
        motion_file = os.path.join(ASE_DIR, "ase/poselib/data/walk_forward_Stompy.npy")
        # motion_file = os.path.join(ASE_DIR, "ase/poselib/data/walk_in_place_Stompy.npy")
