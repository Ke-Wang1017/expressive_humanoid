...
from legged_gym.envs.stompy.stompy_mimic import *
from legged_gym.envs.stompy.stompy_mimic_eval import StompyMimicEval
import os
from legged_gym import LEGGED_GYM_ROOT_DIR, ASE_DIR

class StompyMimicViewMotion(StompyMimicEval):
