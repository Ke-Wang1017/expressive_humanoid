...
class StompyMimic(LeggedRobot):
    ...
    def init_motions(self, cfg):
        ...
        # ['base', 'L_buttock', 'L_leg', 'L_thigh', 'L_calf', 'L_foot', 'L_clav', 'L_scapula', 'L_uarm', 'L_farm', 
        # 'left_hand_keypoint_link', 'R_buttock', 'R_leg', 'R_thigh', 'R_calf', 'R_foot', 'R_clav', 'R_scapula', 'R_uarm', 
